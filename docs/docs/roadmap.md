...
!!! important "As a user I want to see an overview of the project so I can be informed."
    ...
    -   An interactive map lets the user see the cases (anonymazed).
    -   A dashboard section under the map shows the user the metrics of the currently selected region.
...
!!! danger "As a user I want to be guided in the process of contacting an organization and reporting the case so I dont have to put to much effort in learning how the platform works"
    - A chatbot propmts and ask if it can help.
    - A chatbot guides the user to the main resources close to its location.
...
!!! important "As a user I want to be able to report a case so I can share my experience"
    -   A Call to Action is accesible by the user and redirects to the form page.
...
!!! warning "As a user I want to be able to be reached by others in my situation so I can share my experience one-to-one"
...
!!! important "As a user I want to know the metrics of similar cases so that I can get inform or contact people with a similar case."
    ...
    -   In the confirmation page there is a section with e-mails of users that have authorized to be contacted by similar cases.
